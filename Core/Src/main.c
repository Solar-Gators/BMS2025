...
/* Definitions for Temp_Monitoring */
osThreadId_t Temp_MonitoringHandle;
const osThreadAttr_t Temp_Monitoring_attributes = {
  .name = "Temp_Monitoring",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityHigh,
};
/* Definitions for Current_Monitor */
osThreadId_t Current_MonitorHandle;
const osThreadAttr_t Current_Monitor_attributes = {
  .name = "Current_Monitor",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for Battery_Data_Tr */
osThreadId_t Battery_Data_TrHandle;
const osThreadAttr_t Battery_Data_Tr_attributes = {
  .name = "Battery_Data_Tr",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityAboveNormal,
};
/* Definitions for Update_Fan_Spee */
osThreadId_t Update_Fan_SpeeHandle;
const osThreadAttr_t Update_Fan_Spee_attributes = {
  .name = "Update_Fan_Spee",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityAboveNormal,
};
/* USER CODE BEGIN PV */
...
/**
* @brief Function implementing the Temp_Monitoring thread.
* @param argument: Not used
* @retval None
*/
...
/**
* @brief Function implementing the Current_Monitor thread.
* @param argument: Not used
* @retval None
*/
...
/**
* @brief Function implementing the Battery_Data_Tr thread.
* @param argument: Not used
* @retval None
*/
...
/**
* @brief Function implementing the Update_Fan_Spee thread.
* @param argument: Not used
* @retval None
*/
